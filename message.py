...
class MessageBuilder(object):
    ...
    @contextmanager
    def build(self, target_date: datetime):
        """
        通知するメッセージとグラフを生成する。
    ...
    def _build_tweet_count_message(self, data_list):
        """
    ...
    @classmethod
    def _build_feature_words_message(cls, data_list):
        """
        特徴語ランキングのメッセージを生成する
        """
        latest_data = data_list[0]
    ...
    @classmethod
    def _create_chart_img(cls, data_list):
        """
        つぶやき数の推移グラフを生成する
        """
    ...
    @classmethod
    def _build_attachments(cls, title: str, text: str):
        """
        Attachmentsを生成する
    ...
    @property
    def tweet_count_attachments(self):
        return self._build_attachments('つぶやき数', self._tc_message)

    @property
    def feature_words_attachments(self):
